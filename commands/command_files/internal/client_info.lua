...
local name = "clientinfo" -- Name of the command.
...
local signature = "clientinfo" -- Type signature of the command for help files.
...
local description = [[
Provides some information about the client currently serving the guild.]]
...
local function command(guild, author, message, args)
    message:reply(Embeds.clientInfo(message))
end
