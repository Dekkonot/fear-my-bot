...
local WeakCache = {
    ...
    --'get' isn't here since it's described above and the only difference is the complexity, which isn't noted.

    ---Returns an iterator that returns all contained objects.
    ---The order of the objects is not guaranteed.
    ---@param self Cache
    ---@return Cache
